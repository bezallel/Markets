...
const marketsData = [
    ...
    {  name: "Ogba Sunday Market", location: "Wemco Rd, Aguda 101233, Ojodu. ",info: "The Ogba Sunday Market primarily focuses on providing a wide range of food products. Located just off Ogba Ijaiye Road, it originally operated primarily on weekends, making it convenient for the working-class population to fulfill their shopping needs. In response to increased demand, the market has expanded its operating hours and now welcomes customers daily."},
