...
const marketsData = [
    ...
    { name: 'Alaba international Market', location: 'Alaba, Ojo.', info: 'Alaba International Market, a renowned electronics hub in Africa located in Lagos, enjoys international recognition, drawing customers from neighboring nations. Operating daily, except on Sundays and public holidays, this bustling marketplace boasts over five thousand shops, making it a prominent destination for electronics trade. Alaba International Market has also emerged as a popular choice in Nigeria and across West Africa for a wide range of imports, notably electronics and household items from East Asian countries like China, Japan, and India.' },
    ...
    {  name: "Computer Village",location: "Ikeja.",  info: "Computer Village, widely recognized as the go-to destination for computer enthusiasts, caters to a diverse range of computer needs, spanning from phones and PCs to electronics, accessories, software, and repair services. Its popularity extends far beyond Lagos, attracting people from across Nigeria. Despite past plans for relocation, it remains firmly in its original location, continuing to thrive as Nigeria's top computer market, and some even argue it holds that title in Africa. Open daily, except on Sundays and public holidays, Computer Village stands as a bustling hub for computer-related businesses."},
