...
const marketsData = [
    ...
    {  name: "Mile 12 Market",location: "Ikorodu Rd, Kosofe Lagos, Ketu",info: "For about 30 years, Mile 12 Market in Lagos has been the largest perishable food market in Nigeria and one of the biggest in West Africa. It handles massive daily volumes of foodstuffs, serving as a key distribution hub for Lagos and beyond, playing a vital role in the region's economy and food supply chain."},
    {  name: "Ogba Sunday Market", location: "Wemco Rd, Aguda 101233, Ojodu ",info: "The Ogba Sunday Market is a market that caters majorly to foodstuffs. It is situated off Ogba Ijaiye Road and was open mostly on weekends. This helped working-class people meet up with their various shopping. Several years back, the market was strictly opened on Sundays, but recently, the market now operates every day due to popular demand."},
